...
class SwaggerConfig {
	...
	private ApiInfo apiInfo() {
		return new ApiInfoBuilder().title("Workstations Microservice - Spring Cloud Netflix")
				.description("API REST documentation about Workstations Microservice").contact("Globant Talent Pool")
				.build();
	}
}